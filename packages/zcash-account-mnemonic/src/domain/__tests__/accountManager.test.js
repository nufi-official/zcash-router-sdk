...
describe('ZCashAccountManager', () => {
    ...
    const accountManager = ZCashAccountManager({ mnemonic: mnemonicProvider }, webWalletManager);
    describe('getAccountOfflineInfo', () => {
        it('should get shielded and transparent addresses for account', async () => {
            ...
            expect(offlineInfo.shieldedAddress).toEqual('u1vu0zkreyef83369fn3dr94zkg2djqlcgtghxf2jmdcdmxp2z4l70dlh6yfdf5v33cteezva2c528syqtmu7uxgzss6fumh3tzjumnqh45z3yewkqplrfdz4f68aahg8x35yknyf7vjh4wy5sn4cc8edkxlef2p4q8ez6e0xuzrmr4rzff54m5t5whyzdgfg2cujtjdjlx2zqu46h7ty');
            expect(offlineInfo.transparentAddress).toEqual('t1XVXWCvpMgBvUaed4XDqWtgQgJSu1Ghz7F');
        }, 30000);
    });
});

# @asset-route-sdk/solana

Solana address-only account management library for the Asset Route SDK.
...
```bash
pnpm add @asset-route-sdk/solana
```
...
```typescript
import { createSolanaAccount } from '@asset-route-sdk/solana';
